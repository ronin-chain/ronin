...
func SubmitTransaction(ctx context.Context, b Backend, tx *types.Transaction) (common.Hash, error) {
	if b.ChainConfig().IsL2Migration(b.CurrentHeader().Number) {
		return common.Hash{}, errors.New("transactions will not be executed on L1 anymore, please switch to L2")
	}
